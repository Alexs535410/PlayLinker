...
📦 API模块列表：
• 用户认证与监管：账号绑定与数据接入 (AuthController, SteamController, XboxController, PsnController, GogController)
• 游戏数据与平台：游戏数据与元数据 (GamesController, MetadataController, AchievementsController, LibraryController, WishlistController, NewsController, PreferencesController)
• 本地文件与数据：本地游戏管理、存档管理、云存档、Mod管理、报表系统、数据分析 (LocalGamesController, SavesController, CloudController, ModsController, ReportsController, AnalyticsController)
• 家长监管与社交：家长监管与社交功能
