...
│   │   ├── auth.js             # 用户认证与监管
│   │   ├── platform.js         # 用户认证与监管
│   │   ├── notification.js     # 用户认证与监管
│   │   ├── parental.js         # 用户认证与监管
│   │   ├── game.js             # 游戏数据与库管理
│   │   ├── library.js          # 游戏数据与库管理
│   │   ├── achievement.js      # 游戏数据与库管理
│   │   ├── news.js             # 游戏数据与库管理
│   │   ├── steam.js            # 游戏数据与库管理
│   │   ├── xbox.js             # 游戏数据与库管理
│   │   ├── psn.js              # 游戏数据与库管理
│   │   ├── gog.js              # 游戏数据与库管理
│   │   ├── localGame.js        # 本地文件与数据分析
│   │   ├── save.js             # 本地文件与数据分析
│   │   ├── cloud.js            # 本地文件与数据分析
│   │   ├── mod.js              # 本地文件与数据分析
│   │   ├── report.js           # 本地文件与数据分析
│   │   ├── analytics.js        # 本地文件与数据分析
│   │   ├── preference.js       # 推荐与价格监控
│   │   ├── recommendation.js   # 推荐与价格监控
│   │   ├── price.js            # 推荐与价格监控
│   │   └── wishlist.js         # 推荐与价格监控
│   │
│   ├── assets/                  # 资源文件
